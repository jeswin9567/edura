  ...
  return (
    <section className="uhome-services-section" ref={ref}>
      ...
      <div className="uhome-services">
        <button className="uhome-service-btn" onClick={() => navigate('/manager/entrance')}>
        ...
        <button className="uhome-service-btn" onClick={() => navigate('/manager/scholarship')}>
        ...
        <button className="uhome-service-btn" onClick={() => navigate('/manager/loan')}>
